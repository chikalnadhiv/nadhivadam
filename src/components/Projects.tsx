  ...
  return (
    <section id="projects" className="py-20 md:py-28 transition-colors duration-300">
      <div className="mx-auto max-w-6xl px-6 md:px-8">
        ...
        {/* Card Grid — data is pre-fetched on server, no loading state needed */}
        <motion.div
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map((techItem) => (
                      <span
                        key={techItem}
                        className="rounded-full bg-gradient-to-r from-primary/10 to-accent/10 px-3 py-1 text-xs font-semibold text-primary border border-primary/20 transition-all duration-300 group-hover:border-primary/40 group-hover:bg-primary/15"
                      >
                        {techItem}
                      </span>
                    ))}
                  ...
                  <a
                    ...
                    className="inline-flex items-center justify-center gap-1.5 w-full btn-primary px-4 py-2.5 text-xs"
                  >
                    Explore Project
